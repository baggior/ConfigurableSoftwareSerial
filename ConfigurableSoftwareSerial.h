...
class ConfigurableSoftwareSerial : public Stream
{
public:
    ConfigurableSoftwareSerial(int receivePin, int transmitPin, bool inverse_logic = false, unsigned int buffSize = 64);
